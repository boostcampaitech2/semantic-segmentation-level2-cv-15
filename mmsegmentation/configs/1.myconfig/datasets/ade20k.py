...
data_root = '/opt/ml/mmsegmentation/data'
dataset_fold = 4
...
test_pipeline = [
    ...
    dict(
        type='MultiScaleFlipAug',
        img_scale=[(384, 384), (512, 512), (768, 768)],
        # img_scale=(512, 512),
        img_ratios=[0.75, 1.0, 1.25],
        flip=False,
        transforms=[
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir=f'{data_root}/images/train_{dataset_fold}',
        ann_dir=f'{data_root}/annotations/train_{dataset_fold}',
        classes=CLASSES,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir=f'{data_root}/images/val_{dataset_fold}',
        ann_dir=f'{data_root}/annotations/val_{dataset_fold}',
        classes=CLASSES,
